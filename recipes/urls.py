...
urlpatterns = [
    ...
    path("recipe/<int:recipe_id>/edit/",
         views.recipe_edit,
         name="recipe_edit"),
    path("recipe/<slug:recipe_slug>/edit/", views.recipe_edit,
         name="recipe_edit"),
    ...
    path('purchase/delete/<int:recipe_id>/', views.delete_purchase,
         name='delete_purchase'),
    path('purchase/download/', views.download_purchase,
